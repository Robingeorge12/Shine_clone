        ...
        <div>
                ...
                <div className={task.head}>
                    ...
                    <div className={task.headcont}>
                        ...
                        <div style={{display:"flex",justyfyContent:"center" , alignItems:"center"}} onClick={()=>navigate("https://www.shine.com/")}>
                        ...
                        <div style={{display:"flex",justyfyContent:"center" , alignItems:"center"}}>
...
<div className={task.head2}>
                ...
                <div style={{display:"flex" ,gap:"1rem"}}>
                        ...
                        <div style={{marginTop:"20px", width:"50%" ,boarder:"1px solid black",display:"flex",}}>
                           ...
                           <button className={task.btn1} style={{backGroundcolor:"violet"}}>
                            <Search2Icon/>
